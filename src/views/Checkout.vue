  ...
  <div class="max-w-4xl mx-auto">     
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8"> 
        ...
        <div class="card p-6"> 
          ...
          <div class="mt-6 pt-6 border-t"> 
            <div class="flex justify-between items-center mb-2"> 
              <span class="text-gray-600"> Барлығы:</span> 
              <span class="font-medium">{{ cartStore.totalPrice.toFixed(2) }} т </span> 
            </div> 
            <div class="flex justify-between items-center mb-2">  
              <span class="text-gray-600">Жеткізу</span> 
              <span class="font-medium">5.00т</span> 
            </div>  
            <div class="flex justify-between items-center mb-2"> 
              <span class="text-gray-600">Салық</span>  
      ...
      <div class="md:col-span-1"> 
        <div class="card p-6"> 
          <h2 class="text-xl font-semibold mb-4">Төлем мәліметтері</h2>
          <form @submit.prevent="handleSubmit" class="space-y-4">
            <div>         
              <label class="block text-sm font-medium text-gray-700 mb-1">Карта нөмірі</label>           
         <input type="text" placeholder="1234 5678 9012 3456" class="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500">                  
            ...
            <div class="grid grid-cols-2 gap-4">    
              <div>           
                <label class="block text-sm font-medium text-gray-700 mb-1">      Жарамдылық мерзімі</label>
            ...
            <div>             
              <label class="block text-sm font-medium text-gray-700 mb-1">   Карточкадағы аты</label>  
            ...
            <button type="submit" class="btn btn-primary w-full">Тапсырыс беріңіз</button>
          </form>
        </div>
      </div>
    </div>
